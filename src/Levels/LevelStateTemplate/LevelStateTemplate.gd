...
func _ready() -> void:
	...
	LevelState.add_wave([
		LevelState.create_spawn([
			LevelState.create_enemy(ENEMY_TYPE.MELEE, 2.0),
			LevelState.create_enemy(ENEMY_TYPE.MELEE, 1.0)
		], 0, false),
		LevelState.create_spawn([
			LevelState.create_enemy(ENEMY_TYPE.MELEE, 1.0),
			LevelState.create_enemy(ENEMY_TYPE.MELEE, 3.0)
		], 1, false),
		LevelState.create_spawn([
			LevelState.create_enemy(ENEMY_TYPE.MELEE, 1.0),
		], 2, false)
	...
	LevelState.add_wave([
		LevelState.create_spawn([
			LevelState.create_enemy(ENEMY_TYPE.RANGE, 1.0),
			LevelState.create_enemy(ENEMY_TYPE.RANGE, 3.0),
		], 0, true)
	])
